...
?>
<script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script><script type="text/javascript">stLight.options({publisher:'0af7abb9-0ce7-49b9-8400-5387910df340'});</script>
<?php
...
<a class="addthis_button" href="http://www.addthis.com/bookmark.php?v=250&amp;username=<?php echo $addThisUN ?>"><img src="http://s7.addthis.com/static/btn/sm-share-en.gif" width="83" height="16" alt="Bookmark and Share" style="border:0"/></a><script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#username=<?php echo $addThisUN ?>"></script>
<span class="st_twitter_hcount" displayText="Tweet"></span><span class="st_facebook_hcount" displayText="Like"></span>
<?php } //end if add this ?>
...
<?php
echo '<li><a href="'.$siteroot.'/blog/comments/'.strtolower($dbcat_categoryName).'/'.$permaLink.'"> Comments ('.$commentCount.') </a></li>';
?>
<?php if (isset($_SESSION['userID']) && $_SESSION['usr_access_lvl'] <= 2) { ?>
<li><a href="<?php echo $siteroot ?>/socket/modules/blog/admin_blog_edit.php?ID=<?php echo $articleID; ?>"> Edit </a></li>
<?php } ?>
</ul>
</div>
<?php
