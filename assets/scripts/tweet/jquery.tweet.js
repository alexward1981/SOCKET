(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["invasionmedia"],              // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      ...
      query: "&tag=imnews&from=invasionmedia"         // [string]   optional search query
    };
