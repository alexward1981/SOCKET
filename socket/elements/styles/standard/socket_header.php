...
<link rel="stylesheet" href="<?php echo SITEROOT ?>/assets/scripts/formValidator/css/validationEngine.jquery.css" type="text/css" media="screen" charset="utf-8" />
<script src="<?php echo SITEROOT ?>/assets/scripts/formValidator/js/jquery.js" type="text/javascript"></script>
<script src="<?php echo SITEROOT ?>/assets/scripts/formValidator/js/jquery.validationEngine-en.js" type="text/javascript"></script>
<script src="<?php echo SITEROOT ?>/assets/scripts/formValidator/js/jquery.validationEngine.js" type="text/javascript"></script>
...
<style>
.is0{background:url(<?php echo SITEROOT?>/socket/assets/images/progressImg1.png) no-repeat 0 0;width:244px;height:14px;}
...
<script src="<?php echo SITEROOT ?>/assets/scripts/idle-timer.js" type="application/javascript"></script>
...
<a href="<?php echo SITEROOT ?>/socket/index.php"><img id="socketlogo" src="<?php echo SITEROOT ?>/socket/assets/images/socket_logo.png" alt="SOCKET Logo" title="Return to SOCKET homepage" /></a>
<div id="primary_nav">
