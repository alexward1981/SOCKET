...
echo '<a href="'.$siteroot.'/modules/blog/article.php?article='. $result['permaLink'].'"><img src="' . $siteroot . '/socket/elements/buttons/button_open.png"  title="View article on live site" /></a></td>';
...
// EDIT ARTICLES
echo '<td class="buttonCol2">';
echo '<a href="admin_blog_edit.php?ID='. $result['articleID'].'"><img src="' . $siteroot . '/socket/elements/buttons/button_edit.png"  title="Edit Article" /></a></td>';
...
echo '<td class="buttonCol">';	
echo '<a href="admin_blog_revisions.php?ID='. $result['articleID'].'"><img src="' . $siteroot . '/socket/elements/buttons/button_view_menus.png"  title="View Revisions" /></a></td>';
}
// DELETE ARTICLES
