...
if($_GET['ID'])
	...
	$dblookup = "SELECT * FROM module_blog WHERE articleID=" . $_GET['ID'];
	...
	elseif (!empty($_POST['submit'])) // If the updates have been submitted
	{
		...
		$saveArticle = mysql_query("SELECT * FROM module_blog WHERE articleID =" . $_POST['articleID']) or die ('No articles found');
...
<script language="JavaScript">
  ...
  <p>
    ...
    <div class="inputcontainer">
		  ...
		  <?php 
          $catlookup = "SELECT categoryID, categoryName FROM module_blog_categories";
