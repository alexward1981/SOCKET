...
echo '<a href="'.$siteroot.'/modules/blog/article.php?article=true&amp;revision='. $result['revisionID'].'"><img src="' . $siteroot . '/socket/elements/buttons/button_open.png"  title="View revision on live site (not visible to the public)" /></a></td>';
