...
if(isset($_GET['ID']))
	...
	$dblookup = "SELECT moduleID, folder_name, stylesheet_name, display_name, has_menu, access_control, installed, compatible, active FROM core_modules WHERE moduleID=" . $_GET['ID'];
	...
	list($moduleID, $folder_name, $stylesheet_name, $display_name, $has_menu, $access_control, $installed, $compatible, $active) = mysql_fetch_array($data, MYSQL_NUM);
	}
elseif (!empty($_POST['submit'])) 
	...
	$dbupdate = "UPDATE core_modules SET moduleID = '$moduleID', folder_name = '$folder_name', stylesheet_name = '$stylesheet_name', display_name = '$display_name', has_menu = '$has_menu', access_control = '$access_control', compatible = '$compatible', active = '$active' WHERE moduleID = '$moduleID'";
...
<script language="JavaScript">
      window.location.href = '<?php echo SOCKETROOT ?>/modules/admintools/modules.php?message=' + <?php echo $message; ?>;
</script>
