...
if(isset($_GET['ID']))
	...
	$modulelookup = "SELECT menuID, moduleID, menu_item_name, menu_path, access_control FROM core_modules_menus WHERE menuID=" . $_GET['ID'];
	...
	list($menuID, $moduleID, $menu_item_name, $menu_path, $access_control) = mysql_fetch_array($moduledata, MYSQL_NUM);
	}
...
$dbinsert = "UPDATE core_modules_menus SET moduleID = '$moduleID', menu_item_name = '$menu_item_name', menu_path = '$menu_path', access_control = '$access_control' WHERE menuID = $menuID";
 ...
 ?>
          ...
          <input name="menuID" type="hidden" value="<?php echo $menuID ?>" />
            ...
            <label for="moduleID"><select name="moduleID">
                  <?php 
                  $dblookup = "SELECT moduleID, display_name FROM core_modules WHERE moduleID = $moduleID";
           ...
           <p>
            ...
            <p>															 
              <label>Menu Item File Name (include subfolders if required)<br />
                <input name="menu_path" type="text" id="menu_path" size="50" class="required" value="<?php echo $menu_path ?>">
              </label>
            </p>
