...
echo '    <img src="'.$siteroot.'/Scripts/phpThumb/phpThumb.php?src='.$result['usr_avatar'].'&amp;w=35&amp;h=35&amp;zc=c" alt="'.$result['usr_username'].'\'s profile picture"/></td>';
} else
{
...
echo '    <a href="admin_users_edit.php?ID='. $result["userID"].'"><img src="' . $socketroot . '/elements/buttons/button_edit.png" width="32" height="32" alt="Edit User" /></a></td>';
		...
		echo '<img src="' . $siteroot . '/socket/elements/buttons/off_button_edit.png" width="32" height="32" alt="Cannot Edit User" /></td>'; }
// Admin switch yet to add
	...
	echo '<a href="javascript:deleteContent(\''. $result["userID"].'\');"><img src="' . $socketroot . '/elements/buttons/button_delete.png" width="32" height="32" alt="Delete User" /></a></td>';
		...
		echo '<td width="28" class="deadcol" align="center">';
		echo '<img src="' . $socketroot . '/elements/buttons/off_button_delete.png" width="32" height="32" alt="Cannot Delete User" /></td>'; }
echo '  </tr>';
