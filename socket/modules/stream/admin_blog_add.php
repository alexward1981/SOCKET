...
require_once('../../templates/standard/socket_header.php'); ?>
                 <p class="float_right button"> <a href="<?php echo $siteroot?>/socket/index.php">Discard</a></p>   <h1> Add stream Article </h1>
          <p>From here you can add new stream articles to your website</p>
          <?php
...
$dbinsert = "INSERT INTO module_stream (articleID, articleTitle, permaLink, articleBody, articleSummary, articleImage, articleImagePos, articleImageAlt, articleAuthor, GlobalAuthor, articleCat, datePosted, articlePosted) VALUES ('$articleID', '$articleTitle', '$permaLink', '$articleBody', '$articleSummary', '$articleImage', '$articleImagePos', '$articleImageAlt', '$articleAuthor', '$GlobalAuthor', '$articleCat', now(), '$articlePosted')";
...
?>
          <form enctype="multipart/form-data" id="socket_form" action="<?php $_SERVER['../Copy of stream/SCRIPT_NAME']; ?>" method="post">
		  ...
		  <?php 
          $dblookup = "SELECT categoryID, categoryName FROM module_stream_categories";
