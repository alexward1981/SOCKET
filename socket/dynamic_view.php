...
$dblookup = "SELECT dynamicID, userID, articleTitle, articleBody FROM core_dynamic WHERE dynamicID=" . $_GET['ID'];
...
while(list($dynamicID, $userID, $title, $content) = mysql_fetch_array($data, MYSQL_NUM))
{

/*HTML starts here */
?>
<h3> <?php echo "Viewing: " . $title; ?>&nbsp;(<a href="dynamic_edit.php?ID=<?php echo $dynamicID; ?>">Edit</a>)</h3>
